...
import { updateBot, deleteBot as deleteBotService } from "@services/bot";
...
export const SettingsCard = ({
  ...
  const onFinish = async (values: any) => {
    return await updateBot(params.id!.toString(), values);
  };
  ...
  const onDelete = async () => {
    return await deleteBotService(params.id!.toString());
  };
