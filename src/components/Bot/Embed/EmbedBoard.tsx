  ...
  return (
    <div className="divide-y lg:col-span-9">
      <EmbedBoardTitle
        ...
        content={`${hostUrl}/#/embed/chat`}
      />

      <EmbedBoardTitle
        title="Iframe"
        description="You can use this iframe to embed your bot"
        content={`<iframe src="${hostUrl}/#/embed/chat?mode=iframe" width="400" height="500" />`}
      />

      <EmbedBoardTitle
        title="Script"
        description="You can use this script to embed your bot to your website or web app"
        content={`<script src="${hostUrl}/chat.min.js" data-chat-url="${hostUrl}/#/embed/chat" data-btn-position="bottom-right" defer></script>`}
      />
    </div>
  );
};
