...
export const AppearancePreview = ({
  ...
  form: FormInstance;
  botStyleBg: string;
  botStyleTextColor: string;
  humanStyleBgColor: string;
  humanStyleTextColor: string;
}) => {
  const botName = Form.useWatch("botName", form);
  const firstMessage = Form.useWatch("greetingMessage", form);
        ...
        <div className="grow px-4 sm:px-6 md:px-5 py-6">
          <div className="flex w-full mt-2 space-x-3 ">
            <div
              ...
              style={{
                backgroundColor: botStyleBg,
                color: botStyleTextColor,
              }}
            >
          ...
          <div className="flex w-full mt-2 space-x-3 max-w-xs ml-auto justify-end">
            <div
              style={{
                backgroundColor: humanStyleBgColor,
                color: humanStyleTextColor,
              }}
